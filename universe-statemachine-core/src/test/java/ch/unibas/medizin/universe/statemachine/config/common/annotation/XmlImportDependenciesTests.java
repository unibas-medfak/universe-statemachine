...
import ch.unibas.medizin.universe.statemachine.config.common.annotation.simple.SimpleTestConfigBeanABuilder;
import ch.unibas.medizin.universe.statemachine.config.common.annotation.simple.SimpleTestConfigBeanBConfigurer;
...
public class XmlImportDependenciesTests {
	...
	@Configuration
	@EnableSimpleTest
	@ImportResource("ch/unibas/medizin/universe/statemachine/config/common/annotation/XmlImportDependencies.xml")
