...
import ch.unibas.medizin.universe.statemachine.action.SpelExpressionAction;
...
import ch.unibas.medizin.universe.statemachine.event.OnStateMachineError;
import ch.unibas.medizin.universe.statemachine.event.StateMachineEvent;
		...
		public SpelAction action3() {
			...
			return new SpelAction(
					parser.parseExpression(
							"stateMachine.sendEvent(T(ch.unibas.medizin.universe.statemachine.docs.Events).E1)"));
		}
