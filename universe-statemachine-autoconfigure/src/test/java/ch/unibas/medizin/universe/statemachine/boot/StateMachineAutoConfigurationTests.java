 ...
 */
package ch.unibas.medizin.universe.statemachine.boot;
...
import ch.unibas.medizin.universe.statemachine.boot.autoconfigure.StateMachineAutoConfiguration;
...
public class StateMachineAutoConfigurationTests {
	...
	public void testMonitorDisabled() throws Exception {
		context = new AnnotationConfigApplicationContext();
		TestPropertyValues.of("universe.statemachine.monitor.enabled=false").applyTo(context);
		context.register(StateMachineAutoConfiguration.class);
		context.refresh();
