 ...
 */
package ch.unibas.medizin.universe.statemachine.boot.autoconfigure;
...
import ch.unibas.medizin.universe.statemachine.boot.StateMachineProperties;
import ch.unibas.medizin.universe.statemachine.boot.actuate.InMemoryStateMachineTraceRepository;
import ch.unibas.medizin.universe.statemachine.boot.actuate.StateMachineTraceEndpoint;
import ch.unibas.medizin.universe.statemachine.boot.actuate.StateMachineTraceRepository;
import ch.unibas.medizin.universe.statemachine.boot.support.BootStateMachineMonitor;
...
@ConditionalOnProperty(prefix = "universe.statemachine.monitor", name = "enabled", havingValue = "true", matchIfMissing = true)
